...
export const Button = ({ children, disabled = false, to, type }) => {
  ...
  const styles = {
    ...
    secondary: 'rounded-full border-2 uppercase border-stone-300 text-base text-zinc-300 transition-colors duration-300 hover:bg-red-400 disabled:cursor-not-allowed px-4 py-2.5 md:px-6 md:py-3.5',
